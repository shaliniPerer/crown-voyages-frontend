                    ...
                    <div key={idx} className="bg-white rounded-lg p-3 border border-green-200">
                      ...
                      {config.children > 0 && config.childrenAges && config.childrenAges.length > 0 && (
                        <p className="text-xs text-gray-500 mt-1">
                          Ages: {config.childrenAges.filter(age => age > 0).join(', ') || 'Not specified'}
                        </p>
                      )}
                    </div>
                  ))}
                      ...
                      {room.children.map((child, childIdx) => (
                        <div key={childIdx} className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                          ...
                          <div className="space-y-1 text-sm">
                            ...
                            <p><span className="font-medium text-gray-600">Age:</span> <span className="text-gray-900">{child.age || 'Not provided'}</span></p>
